...
const defects = [
  ...
  d('D048', 37, 2, 'Before Delivery', 'Packaging Material Damaged', 'Hold for Review', 'ready_verification', '2026-06-13 08:20:00', { qty: 12, hold: 12, worker: 3, priority: 'medium', reviewDue: '2026-06-13' }),
...
const actions = [
  ...
  ca('CA011', 20, 3, '2026-03-25', 'high', 'cancelled', '2026-03-18 10:00:00', { type: 'machine_process_check', task: 'Cancelled — previously rejected (sealing test photo unclear); not redone.' }),
  ...
  ca('CA015', 18, 3, '2026-03-20', 'critical', 'cancelled', '2026-03-12 08:00:00', { task: 'Cancelled — previously rejected (containment steps incomplete); not redone.' }),
...
const monthlyActionSupplements = [
  ...
  ca('CA040', 5, 2, '2026-02-03', 'medium', 'verified', '2026-01-14 10:00:00', { task: 'Recheck weighing after relabelling run.', started: '2026-01-16 09:00:00', completed: '2026-02-02 14:00:00', verified: '2026-02-03 09:30:00' }),
  ca('CA041', 4, 3, '2026-01-28', 'medium', 'verified', '2026-01-18 11:00:00', { type: 'machine_process_check', task: 'Adjust sealing machine pressure; Test sealing sample', started: '2026-01-19 09:00:00', completed: '2026-01-22 14:00:00', verified: '2026-01-28 11:00:00' }),
  ca('CA042', 4, 3, '2026-01-25', 'medium', 'cancelled', '2026-01-16 09:00:00', { type: 'machine_process_check', task: 'Cancelled — previously rejected (sealing test photo incomplete); not redone.' }),
  ...
  ca('CA046', 8, 3, '2026-02-25', 'medium', 'verified', '2026-02-19 14:00:00', { type: 'machine_process_check', task: 'Adjust sealing machine pressure; Test sealing sample', started: '2026-02-20 09:00:00', completed: '2026-02-23 16:00:00', verified: '2026-02-20 12:00:00' }),
  ca('CA047', 11, 3, '2026-03-05', 'medium', 'cancelled', '2026-02-16 10:00:00', { task: 'Cancelled — previously rejected (storage photo missing batch label); not redone.' }),
  ...
  ca('CA051', 28, 3, '2026-04-25', 'medium', 'verified', '2026-04-12 10:00:00', { type: 'machine_process_check', task: 'Adjust sealing machine pressure; Test sealing sample', started: '2026-04-14 09:00:00', completed: '2026-04-21 16:00:00', verified: '2026-04-22 11:45:00' }),
  ca('CA052', 27, 2, '2026-04-20', 'medium', 'verified', '2026-04-08 11:00:00', { task: 'Relabel untidy labels on April run.', started: '2026-04-10 09:00:00', completed: '2026-04-17 15:00:00', verified: '2026-04-18 10:00:00' }),
  ca('CA053', 30, 2, '2026-04-28', 'medium', 'cancelled', '2026-04-16 09:00:00', { task: 'Cancelled — previously rejected (before/after label photos not attached); not redone.' }),
  ...
  ca('CA057', 37, 3, '2026-05-25', 'medium', 'cancelled', '2026-05-18 09:00:00', { type: 'machine_process_check', task: 'Cancelled — previously rejected (sample count below SOP minimum); not redone.' }),
  ca('CA058', 39, 3, '2026-06-02', 'medium', 'cancelled', '2026-05-26 08:00:00', { task: 'Cancelled after retort parameter update.' }),
  ca('CA059', 15, 3, '2026-03-20', 'medium', 'verified', '2026-03-05 09:00:00', { type: 'machine_process_check', task: 'Adjust sealing machine pressure; Test sealing sample', started: '2026-03-10 09:00:00', completed: '2026-03-17 14:00:00', verified: '2026-03-18 12:00:00' }),
  ca('CA060', 16, 2, '2026-03-22', 'medium', 'verified', '2026-03-08 10:00:00', { task: 'Reset / adjust weighing tool; Recheck weighing procedure', started: '2026-03-10 09:00:00', completed: '2026-03-19 15:00:00', verified: '2026-03-20 09:45:00' }),
  ca('CA061', 17, 3, '2026-03-25', 'medium', 'verified', '2026-03-12 11:00:00', { type: 'machine_process_check', task: 'Check retort temperature; Adjust cooking temperature / time', started: '2026-03-14 09:00:00', completed: '2026-03-18 15:00:00', verified: '2026-03-22 11:30:00' })
]
